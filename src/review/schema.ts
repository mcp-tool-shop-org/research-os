...
export const ReviewSnapshotSchema = z.object({
  ...
  decision_counts: z.partialRecord(ReviewDecisionSchema, z.number().int().nonnegative()),
  severity_counts: z.partialRecord(FindingSeveritySchema, z.number().int().nonnegative()),
