...
फ्रीज किए गए पैकेज [`mcp-tool-shop-org/research-packs`](https://github.com/mcp-tool-shop-org/research-packs) में संग्रहीत हैं—ये लाइव हैं, और इसमें छह बंद "डॉगफूड" प्रयोगों से संबंधित चार पैकेज शामिल हैं। v1.0 के लिए रोडमैप [`docs/roadmap.md`](docs/roadmap.md) में देखें।
...
> **`freeze` आउटपुट पर ध्यान दें।** `research-os freeze` कमांड चुपचाप काम करता है, यह सभी महत्वपूर्ण फाइलों की जांच करता है और सामग्री हैश की गणना करता है—इसलिए इस कमांड के लिए कोई प्रगति बार नहीं है। बड़े पैकेजों के लिए, यह कुछ सेकंड तक चल सकता है और फिर कुछ भी प्रिंट नहीं कर सकता। जब यह समाप्त होता है, तो यह एक ही परिणाम ब्लॉक प्रिंट करता है (`PASS` / `REFUSED` और पाथ)। इस अंतराल को सिस्टम के हैंग होने के रूप में न समझें।

> **`--force` चेतावनी।** `--force` विकल्प लक्षित पैकेज निर्देशिका को साफ़ करता है और उसे बदल देता है। उत्पन्न पैकेज आउटपुट में मैन्युअल रूप से बनाए गए फ़ाइलों को न रखें। इसके बजाय, मूल फ़ाइलों (दावे, स्रोत, संश्लेषण) या संबंधित फ़ाइलों को संपादित करें। पूर्ण स्वीकृति अनुबंध + अस्वीकृति के मामले: [`docs/pack-publish.md`](docs/pack-publish.md)।
...
**v1.0.0** — npm पर `@mcptoolshop/research-os@1.0.0` के रूप में प्रकाशित, 2026-05-11। v1.0.0 एक औपचारिक रिलीज़ है: कार्यप्रणाली सिद्ध है, विफलता के तरीके बताए गए हैं, और संश्लेषण अभी भी प्रमाणों पर निर्भर है। **`research-os` डिफ़ॉल्ट रूप से किसी भी विश्वसनीय समीक्षक मॉडल को शामिल नहीं करता है।** यह समीक्षक प्रोफाइल को प्रमाणित, अस्वीकार या सशर्त रूप से स्वीकार करने के लिए आवश्यक उपकरण प्रदान करता है। इसमें चार-चरणीय "डॉगफूड" प्रक्रिया (चरण A: बग/सुरक्षा, B: सक्रिय लचीलापन, C: ऑपरेटर अनुकूलन, D: प्रस्तुति में सुधार) शामिल है, जो 23 प्रोडक्शन कोड फ़ाइलों में 188 नए परीक्षण, +14 दस्तावेज़/साइट फ़ाइलें और +2 नए सहायक मॉड्यूल (`src/cli/help-topics.ts`, `src/util/progress.ts`) उत्पन्न करते हैं; दो सुधारे गए "क्रॉस-डोमेन" स्थानांतरण प्रक्रियाओं (A-RE-001 कॉलर माइग्रेशन, C2-RE-001 क्रॉस-डोमेन पिकअप) के बाद "क्रॉस-डोमेन" स्थानांतरण सिद्धांत को मानकीकृत किया गया; `--force` कमांड का सटीक वाक्य 8 स्थानों पर "रिग्रेशन टेस्ट" के साथ जांचा गया; 12 `ResearchOSError` उपवर्गों के लिए त्रुटि-विशिष्ट दस्तावेज़; `research-os help <topic>` के माध्यम से स्थैतिक पुनर्प्राप्ति सुविधा (4 विषय लॉक किए गए); `--no-progress` / `--progress` TTY-डिटेक्शन थ्रेडिंग समीक्षा/संग्रहण/विरोधाभास-मैपिंग/पैकेज-प्रकाशन के साथ म्यूटिक्स (mutex) का उपयोग। **कोई भी विश्वसनीय बेसलाइन स्वीकार नहीं की गई है।** **सभी चार फ्रीज किए गए पैकेज v0.3.3 बेसलाइन के खिलाफ बाइट-दर-बाइट सत्यापित हैं।** 901/901 विटेस्ट पास। ज्ञात सीमाएं [CHANGELOG.md](CHANGELOG.md) और [`handbook/known-limitations.md`](https://mcp-tool-shop-org.github.io/research-os/handbook/known-limitations/) में संरक्षित हैं: फ्रीज किए गए पैकेज का संस्करण-चिह्न एक ऐतिहासिक कलाकृति है (B-E-001), npm प्रमाणन को v1.x तक स्थगित किया गया है (B-E-004), इंडेक्स स्कीमा-संस्करण माइग्रेशन केवल प्रकटीकरण पर आधारित है, स्वचालित माइग्रेशन नहीं (B-A-003)। [`docs/release-notes/v1.0.0.md`](docs/release-notes/v1.0.0.md) और [`docs/v1-dogfood-swarm-proof.md`](docs/v1-dogfood-swarm-proof.md) देखें।
...
- बाहरी उपयोगकर्ताओं द्वारा परीक्षण नहीं किया गया है, केवल आंतरिक परीक्षणों तक ही सीमित। छह आंतरिक परीक्षण समाप्त हो गए हैं — जिनमें से एक आत्म-संदर्भित था, और पांच अन्य क्षेत्रों (ComfyUI, XRPL, Godot, समीक्षक-कैलिब्रेशन, नियतात्मक-समीक्षक) से संबंधित थे — लेकिन बाहरी उपयोगकर्ताओं द्वारा बड़े पैमाने पर उपयोग अभी भी भविष्य का कार्य है।
...
v1.0 तीन ज्ञात सीमाओं के साथ आता है जो उपयोगकर्ताओं को दिखाई देती हैं। प्रत्येक सीमा को [हैंडबुक में ज्ञात सीमाओं के पृष्ठ](https://mcp-tool-shop-org.github.io/research-os/handbook/known-limitations/) और [CHANGELOG.md](CHANGELOG.md) में प्रलेखित किया गया है। इनमें से कोई भी रिलीज़ को अवरुद्ध नहीं करता है; सभी के लिए एक परिभाषित रिकवरी या निवारण मार्ग है।

- **B-E-001 — v1.0 से पहले के स्थिर संस्करण का संस्करण स्टैंप एक ऐतिहासिक अवशेष है।** v0.3.3 से v0.6.0 तक प्रकाशित स्थिर संस्करणों में `pack.manifest.json` और `pack/research.yaml` में `research_os_version: "0.1.0"` है, जो v0.4 से पहले के एक हार्डकोडेड ढांचे के कारण है। यह सुधार v1.0 में लागू किया गया है (ढांचा अब लाइव `RESEARCH_OS_VERSION` आयात करता है); मौजूदा स्थिर संस्करण नियम 15 के तहत अपरिवर्तनीय हैं। प्रभावित पैकेजों के अंदर मौजूद JSON फ़ाइलों में पहले से ही उनके वर्तमान संस्करण दर्ज हैं।
- **B-E-004 — npm प्रमाणीकरण v1.x तक स्थगित है।** v1.0 के npm tarball को केवल package-shasum के माध्यम से सत्यापित किया जाता है। प्रकाशन प्रक्रिया को Sigstore OIDC के साथ संघर्ष करने वाली CI वर्कफ़्लो में स्थानांतरित करने की योजना है (TranslateGemma 12B स्थानीय रूप से चलता है); यह माइग्रेशन v1.x के लिए निर्धारित है। v1.0 के npm पैकेजों को package-shasum और GitHub रिलीज़ कमिट के माध्यम से सत्यापित करें।
- **B-A-003 — इंडेक्सर स्कीमा-संस्करण माइग्रेशन प्रलेखित है, लेकिन लागू नहीं है।** v1.0 एक लेखन-पक्ष `SCHEMA_VERSION` पूर्णांक के साथ आता है, लेकिन कोई पढ़ने-पक्ष माइग्रेशन रनर नहीं है। प्रलेखित `SCHEMA_VERSION` में वृद्धि होने पर, `.research-os/index.sqlite` को हटा दें और `research-os index build --all` को फिर से चलाएं। स्वयं पैकेज अप्रभावित रहता है - इंडेक्सर प्रमाण और दावों पर एक त्वरण परत है (नियम 8); पुनर्निर्माण idempotent है।
...
v1.0 एक "प्राप्त" स्थिति है, कोई रिलीज़ की तारीख नहीं। सभी छह "डॉगफूड" प्रयोग समाप्त हो गए (Exp1–Exp6, 8 मई, 2026 से 11 मई, 2026 तक), और प्रत्येक प्रयोग से एक "रिसर्च-पैक" तैयार किया गया जिसे [`mcp-tool-shop-org/research-packs`](https://github.com/mcp-tool-shop-org/research-packs) में शामिल किया गया। "आर्क" ने v0.2.0 `research-os pack publish` + पैटर्न 2 (प्रयोग 2), v0.3.0 `--detector` फ़्लैग (F-09), v0.3.1 सेक्शन-स्कोप वाले छूट (F-10/F-11), v0.3.2 सामान्यीकृत स्वीकृत-दावों का लेखा-जोखा (F-36), v0.3.3 गेट-सिमेंटिक्स की स्पष्टता (F-43/F-41), v0.4.0 स्रोत-सत्य अनुशासन (F-27/F-47/F-46), v0.5.0 समीक्षक कैलिब्रेशन, जो एक स्थायी विश्वास अनुबंध के रूप में है (F-48/F-49/F-50), और v0.6.0 नियतात्मक समीक्षक आधारभूत (F-53/F-54) प्राप्त किया। v1.0 के रिलीज़ की तैयारी एक बहु-चरणीय स्वास्थ्य/सुधार प्रक्रिया के माध्यम से जारी है; इस दौरान "आर्किटेक्चर" पर प्रतिबंध लागू है। पूरी योजना [`docs/roadmap.md`](docs/roadmap.md) में उपलब्ध है।
